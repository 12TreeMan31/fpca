...
unsafe extern "C" {
    pub fn ring_new(size: usize) -> *mut ring_buffer;
}
unsafe extern "C" {
    pub fn ring_write(
        self_: *mut ring_buffer,
        new_data: *mut ::std::os::raw::c_uchar,
    ) -> *mut ::std::os::raw::c_uchar;
}
unsafe extern "C" {
    pub fn ring_read(self_: *mut ring_buffer) -> *mut ::std::os::raw::c_uchar;
}
pub const WIDTH: ::std::os::raw::c_ulong = 4;
pub const HEIGHT: ::std::os::raw::c_ulong = 4;
pub const SIZE: ::std::os::raw::c_ulong = 16;
pub const BACKGROUND: ::std::os::raw::c_uchar = 0;
pub const FOREGROUND: ::std::os::raw::c_uchar = 1;
